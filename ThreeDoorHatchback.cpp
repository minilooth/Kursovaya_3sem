...
ThreeDoorHatchback::ThreeDoorHatchback(const string& brand, const string& model, unsigned yearOfProduction, const string& transmissionType, const string& wheelDriveType,
...
ThreeDoorHatchback::ThreeDoorHatchback(Car& car)
{
	brand_ = car.getBrand();
	model_ = car.getModel();
