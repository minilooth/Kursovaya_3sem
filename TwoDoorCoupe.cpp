...
TwoDoorCoupe::TwoDoorCoupe(const string& brand, const string& model, unsigned yearOfProduction, const string& transmissionType, const string& wheelDriveType,
...
TwoDoorCoupe::TwoDoorCoupe(Car& car)
{
	brand_ = car.getBrand();
	model_ = car.getModel();
