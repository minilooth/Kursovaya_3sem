...
FiveDoorHatchback::FiveDoorHatchback(const string& brand, const string& model, unsigned yearOfProduction, const string& transmissionType, const string& wheelDriveType,
...
FiveDoorHatchback::FiveDoorHatchback(Car& car)
{
	brand_ = car.getBrand();
	model_ = car.getModel();
