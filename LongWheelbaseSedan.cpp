...
LongWheelbaseSedan::LongWheelbaseSedan(const string& brand, const string& model, unsigned yearOfProduction, const string& transmissionType, const string& wheelDriveType,
...
LongWheelbaseSedan::LongWheelbaseSedan(Car& car)
{
	brand_ = car.getBrand();
	model_ = car.getModel();
...
LongWheelbaseSedan::~LongWheelbaseSedan() = default;