...
LongWheelbaseSedan::LongWheelbaseSedan(string& brand, string& model, unsigned yearOfProduction, string& transmissionType, string& wheelDrive,
...
string LongWheelbaseSedan::getBodyType()
{
	return bodyType_;
}
