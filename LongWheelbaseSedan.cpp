...
LongWheelbaseSedan::LongWheelbaseSedan()
{
	...
	yearOfProduction_ = 0;
	transmissionType_ = "";
	bodyType_ = "Long-wheelbase sedan";
	wheelDriveType_ = "";
	engineType_ = "";
	engineVolume_ = 0.0;
	bodyColor_ = "";
...
LongWheelbaseSedan::LongWheelbaseSedan(string& brand, string& model, unsigned yearOfProduction, string& transmissionType, string& wheelDriveType,
